...
const Welcome = () => {
  const tours = useCallApi(`https://journeyvibes-server.onrender.com/tours`);
  const services = useCallApi(`https://journeyvibes-server.onrender.com/services`);
  const blogs = useCallApi(`https://journeyvibes-server.onrender.com/blogs`);
  const enquiries = useCallApi(`https://journeyvibes-server.onrender.com/enquiries`);
   const bookings = useCallApi(`https://journeyvibes-server.onrender.com/bookings`);
   const usersignups = useCallApi(`https://journeyvibes-server.onrender.com/usersignup`);
  useEffect(() => {
        window.scrollTo(0, 0);
      }, []);
  return (
